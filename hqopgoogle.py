...
while True:
	...
	url2 = "https://discord.com/api/webhooks/835764960344670228/B4F2PTg5FCNzyMhwudqtC3Oz0-vbvY6AMToIPm987IkBTWpO9keQ0CZMR1oqulNUI4He"
	if show_active():
		connect_websocket(url,url2,token,"@duck","+mt")
	else:
		show_not_on()
		time.sleep(30)
